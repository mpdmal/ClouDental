...
public class TestDB extends CDentAbstractBeanTest {
	...
	public void testDB() throws InvalidPostitAlertException {
		...
		Patient p1 = _dsvcbean.createPatient("Demo Dentist", "Ko", "Pat");
		Patient p2  = _dsvcbean.createPatient("Demo Dentist2", "Dim", "Aza");
		Patient p3 = _dsvcbean.createPatient("Demo Dentist2", "Ge", "Mit" );
